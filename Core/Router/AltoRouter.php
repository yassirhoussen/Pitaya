...
class AltoRouter {
	...
	/**
	  ...
	  */
	private function init($routes = array(), $basePath = '', $matchTypes = array() ) {
	...
	public function mapRoute() {
		$array = require( CONF_PATH . 'route.php');
		if (empty($array))
			throw new RouterException('Can not have an empty route config file. Please at least declare one');
